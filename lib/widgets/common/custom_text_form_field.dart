  ...
  Widget build(BuildContext context) {
    InputBorder inputBorder = OutlineInputBorder(
      ...
      borderSide: BorderSide(
          width: 1, style: showBoarder ? BorderStyle.solid : BorderStyle.none, color: appCtrl.appTheme.border),
    );
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: fillColor ?? appCtrl.appTheme.white,
        ...
        prefixIcon: prefixIcon != null
            ? Padding(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 14), child: prefixIcon)
            : null,
        suffixIcon: suffixIcon != null
            ? Padding(padding: EdgeInsets.symmetric(horizontal: suffixIconPadding ?? 12), child: suffixIcon)
            : null,
      ),
